...
(cl:defmethod cl:initialize-instance :after ((m <apps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'apps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package_rostocan-msg:<apps> is deprecated: use package_rostocan-msg:apps instead.")))
